<template>
	<div>
		<div id='header'>
			<el-menu theme="light" mode="horizontal" class="oj-menu">
        ...
        <router-link to="/adminMain" tag="el-menu-item" v-if="this.$store.state.myUser.role === 'ROLE_SA' || this.$store.state.myUser.role === 'ROLE_TA'">
          <i class="el-icon-s-data"></i>
          <span style="color: black">Admin</span>
        </router-link>
				<template v-if="Login_show">
					<el-button round style="float: right;margin-right: 10px;margin-top: 13px;" @click="loginVisible=true">Login</el-button>
					<el-button round style="float: right;margin-right: 10px;margin-top: 13px;" @click="registerVisible=true">Register</el-button>
				</template>
        <template v-else>
          <div style="float: right;margin-right: 5%; font-size: 30px; margin-top: 13px;"><i class="el-icon-user-solid"></i>
